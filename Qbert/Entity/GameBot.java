...
public class GameBot {
    ...
    private void getBotImage() {
        try {
            upleft = ImageIO.read(new File("src/res/player/playerupleft.png"));
            upright = ImageIO.read(new File("src/res/player/playerupright.png"));
            downleft = ImageIO.read(new File("src/res/player/playerleftdown.png"));
            downright = ImageIO.read(new File("src/res/player/playerdownright.png"));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
