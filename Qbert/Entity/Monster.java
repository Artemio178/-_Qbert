...
public class Monster extends Entity {
    ...
    public Monster(GamePanel gp, Map map, int startRow, int startCol) {
        this.gp = gp;
        this.map = map;
    ...
    private void loadImage() {
        try {
            monsterImage = ImageIO.read(new File("src/res/player/snake.png"));
            jumpUpLeft = ImageIO.read(new File("src/res/player/snakejumpupleft.png"));
            jumpUpRight = ImageIO.read(new File("src/res/player/snakejumpupright.png"));
            jumpDownLeft = ImageIO.read(new File("src/res/player/snakejumpdownleft.png"));
            jumpDownRight = ImageIO.read(new File("src/res/player/snakejumpdownright.png"));
            upLeft = ImageIO.read(new File("src/res/player/snakeupleft.png"));
            upRight = ImageIO.read(new File("src/res/player/snakeupright.png"));
            downLeft = ImageIO.read(new File("src/res/player/snakedownleft.png"));
            downRight = ImageIO.read(new File("src/res/player/snakedownright.png"));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private void startJump(int targetRow, int targetCol) {
        if (isJumping) return;
    ...
    public boolean isInRange(Player player) {
        ...
        float dy = y - player.y;
        float distance = (float) Math.sqrt(dx * dx + dy * dy);
        return distance <= attackRange * sizeMultiplier; // Увеличиваем радиус атаки пропорционально размеру
    }

    public int getDamage() {
        return (int)(damage * sizeMultiplier); // Увеличиваем урон пропорционально размеру
    }
