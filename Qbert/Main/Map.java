...
public class Map extends JPanel {
    ...
    public Map() {
        try {
            cubeTexture = ImageIO.read(new File("src/res/player/Kub.png"));
            coloredCubeTexture = ImageIO.read(new File("src/res/player/KubGreen.png"));
    ...
    public void updateMonsters(float deltaTime) {
        for (Monster monster : monsters) {
            ...
            if (monster.isInRange(playerRef)) {
                playerRef.takeDamage(monster.getDamage());
            }
        }
    }

    // Method to color a tile when player steps on it
