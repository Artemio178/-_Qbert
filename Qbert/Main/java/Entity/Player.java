...
public class Player extends Entity {
    ...
    public void getPlayerImage() {
        try {
            upleft = ImageIO.read(getClass().getClassLoader().getResourceAsStream("player/playerupleft.png"));      // Вверх-влево
            upright = ImageIO.read(getClass().getClassLoader().getResourceAsStream("player/playerupright.png"));    // Вверх-вправо
            downleft = ImageIO.read(getClass().getClassLoader().getResourceAsStream("player/playerleftdown.png"));  // Вниз-влево
            downright = ImageIO.read(getClass().getClassLoader().getResourceAsStream("player/playerdownright.png")); // Вниз-вправо
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
