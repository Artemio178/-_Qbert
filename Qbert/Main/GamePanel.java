...
public class GamePanel extends JPanel implements Runnable {
    ...
    public GamePanel() {
        ...
        try {
            startScreenImage = ImageIO.read(new File("src/res/player/startscreenqbert.png"));
            modeSelectionImage = ImageIO.read(new File("src/res/player/ChooseMode.png"));
            if (modeSelectionImage == null) {
                System.out.println("Ошибка: изображение ChooseMode.png не загружено");
            }
            levelScreenImage = ImageIO.read(new File("src/res/player/level1.png"));
            level2Image = ImageIO.read(new File("src/res/player/level2.png"));
            level3Image = ImageIO.read(new File("src/res/player/level3.png"));
            level4Image = ImageIO.read(new File("src/res/player/level4.png"));
            deathScreenImage = ImageIO.read(new File("src/res/player/deathscreen.png"));
        } catch (Exception e) {
